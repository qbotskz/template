...
public class id024_AppealFromStudent extends Command {
        ...
        switch (waitingType){
            case START:
                ...
                if (currentStudent != null){
                    ...
                    appealFromStudent.setStudent(currentStudent);
                    appealFromStudent.setRole(Role.ROLE_STUDENT);
    ...
    private void sendToPsychologists() throws TelegramApiException {
        ...
        stringBuilder.append(getText(405)).append(" ").append(appealFromStudent.getSenderName()).append(next).
